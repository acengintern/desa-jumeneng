    ...
    <div className="bg-stone-50/50 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16 sm:space-y-20">
        ...
        <section id="alur-publikasi">
          <ScrollReveal direction="up">
            <div className="bg-white rounded-xl border border-stone-200 shadow-xs p-6 sm:p-10 lg:p-12 space-y-8">
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
                <div className="p-5 rounded-lg bg-stone-50 border border-stone-200/70">
                  <div className="w-10 h-10 rounded-md bg-emerald-100 text-emerald-800 font-bold flex items-center justify-center mb-3">
                    1
                  </div>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                <Link
                  href="/kontak"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-emerald-800 hover:bg-emerald-700 active:bg-emerald-900 text-white text-xs sm:text-sm font-semibold transition-colors shadow-xs min-h-[44px]"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white border border-stone-200 hover:bg-stone-50 text-stone-700 text-xs sm:text-sm font-semibold transition-colors shadow-2xs min-h-[44px]"
                >
