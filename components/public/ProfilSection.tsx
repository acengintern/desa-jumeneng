...
export function ProfilSection({ profil, statistik }: ProfilSectionProps) {
  ...
  return (
    <section id="profil" className="py-20 lg:py-28 bg-white scroll-mt-24 sm:scroll-mt-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-20">
          ...
          <ScrollReveal direction="right" className="lg:col-span-6 h-full">
            <div className="bg-emerald-50/50 rounded-3xl p-6 sm:p-8 lg:p-10 border border-emerald-100/80 shadow-xs relative h-full">
          ...
          <ScrollReveal direction="left" delay={150} className="lg:col-span-6 h-full">
        ...
        <div className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <ScrollReveal direction="right" className="lg:col-span-5 h-full">
              <div className="bg-gradient-to-br from-emerald-900 via-emerald-950 to-emerald-900 text-white rounded-3xl p-8 sm:p-10 shadow-lg shadow-emerald-950/20 flex flex-col justify-between relative overflow-hidden h-full">
                <div
            ...
            <ScrollReveal direction="left" delay={150} className="lg:col-span-7 h-full">
              <div className="bg-slate-50/70 rounded-3xl p-6 sm:p-8 border border-slate-200/80 flex flex-col justify-between h-full">
                <div>
                  <span className="text-xs font-semibold uppercase tracking-wider text-emerald-700">
        ...
        <ScrollReveal direction="up" className="mb-16">
          <div className="bg-gradient-to-br from-emerald-50/70 via-white to-amber-50/40 rounded-3xl p-6 sm:p-10 border border-emerald-100/90 shadow-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <ScrollReveal direction="right" className="h-full">
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200/90 shadow-xs hover:border-emerald-200 transition-colors h-full">
