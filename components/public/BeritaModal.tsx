...
export function BeritaModal({ berita, isOpen, onClose }: BeritaModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl bg-white rounded-t-2xl sm:rounded-xl shadow-2xl border-t sm:border border-emerald-100 overflow-hidden transform transition-all duration-300 max-h-[88vh] sm:max-h-[92vh] flex flex-col"
      ...
      >
        ...
        <div className="px-5 py-3.5 sm:p-7 pb-3 sm:pb-5 flex items-start justify-between gap-3 border-b border-slate-100 shrink-0">
          ...
          <button
            ...
            className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors focus:outline-hidden focus:ring-2 focus:ring-emerald-600 shrink-0 border border-slate-200/60"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 sm:p-7 space-y-4 sm:space-y-5 overflow-y-auto modal-scroll flex-1">
          ...
          {berita.gambar_url && !imageError ? (
            <div className="relative w-full h-44 sm:h-72 rounded-lg overflow-hidden bg-slate-100 border border-slate-200 shadow-xs">
              <img
            ...
            <div className="p-3.5 sm:p-5 rounded-lg bg-emerald-50/80 border border-emerald-100 flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-emerald-100 text-emerald-800 flex items-center justify-center shrink-0">
          ...
          <div className="p-3.5 sm:p-5 rounded-lg bg-emerald-50/80 border border-emerald-200/80 text-emerald-950">
        ...
        <div className="p-3 sm:p-5 bg-slate-50 border-t border-slate-100 flex flex-row items-center justify-between gap-2.5 shrink-0">
          <button
            type="button"
            onClick={handleShare}
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2.5 rounded-lg min-h-[44px] text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 active:bg-slate-100 shadow-2xs transition-colors"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex-1 sm:flex-initial sm:w-auto px-5 py-2.5 rounded-lg min-h-[44px] bg-emerald-800 hover:bg-emerald-700 active:bg-emerald-900 text-white text-xs sm:text-sm font-semibold shadow-xs transition-colors flex items-center justify-center gap-1.5"
          >
