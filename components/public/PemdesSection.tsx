...
export function PemdesSection({ pengurus = [] }: PemdesSectionProps) {
  ...
  return (
    <section id="pemerintahan" className="py-20 lg:py-28 bg-slate-50/70 scroll-mt-24 sm:scroll-mt-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal direction="up" className="max-w-3xl mx-auto mb-16 lg:mb-20">
        ...
        <div className="mb-16 lg:mb-20">
          <ScrollReveal direction="up" className="flex items-center gap-3 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {effectiveRw.map((rw, idx) => (
              <ScrollReveal
                ...
                className="h-full"
              >
                <div className="group relative bg-white rounded-2xl p-5 sm:p-6 border border-emerald-100/90 shadow-xs hover:shadow-lg hover:border-emerald-300 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-full">
                  <div>
                    {/* RW Badge */}
            ...
            {effectiveRt.map((rt, idx) => {
              ...
              return (
                <ScrollReveal
                  ...
                  className="h-full"
                >
                  <div className="group bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 hover:border-emerald-300 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-4 h-full">
